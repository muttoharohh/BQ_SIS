        ...
        <div class="main-content">
            <div class="section_content section_content--p10">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-10">Data Pelajaran SMA Kelas 3</h2>
                            <div class="noti__item js-item-menu">
                                ...
                                <div class="mess-dropdown js-dropdown">
                                    ...
                                    <div class="mess__item">
                                        <form action="/adminsma3/create" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <button type="submit" class="btn btn-warning" data-dismiss=""><a href="{{route('admin.sd2')}}">Close </a></button>
                            ...
                            <div class="panel-body">
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <tbody>
                                                @foreach ($smatigas as $smatiga)
                                                <tr>
                                                <td>{{$smatiga->mapel}}</td>
                                                <td>{{$smatiga->judul}}</td>
                                                <td>{{$smatiga->videopel}}</td>
                                                <td>{{$smatiga->dokumen}}</td>
    
                                                <td>
                                                    <a href="/adminsma3/{{$smatiga->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="/adminsma3/{{$smatiga->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Hapus Data ?')">Delete</a>
                                                </td>
                                                <tr>
                                            @endforeach
                                        </tbody>
