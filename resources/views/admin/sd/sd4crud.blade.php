                            ...
                            <div class="noti__item js-item-menu">
                                ...
                                <div class="mess-dropdown js-dropdown">
                                    ...
                                    <div class="mess__item">
                                        <form action="/adminsd4/create" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <button type="submit" class="btn btn-warning" data-dismiss=""><a href="{{route('admin.sd4')}}">Close </a></button>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <tbody>
                                                ...
                                                <td>{{$sdempat->mapel}}</td>
                                                <td>{{$sdempat->judul}}</td>
                                                <td>{{$sdempat->videopel}}</td>
                                                <td>{{$sdempat->dokumen}}</td>
    
                                                <td>
                                                    <a href="/adminsd4/{{$sdempat->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="/adminsd4/{{$sdempat->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Hapus Data ?')">Delete</a>
                                                </td>
                                                <tr>
                                            @endforeach
                                        </tbody>
