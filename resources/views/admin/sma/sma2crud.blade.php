        ...
        <div class="main-content">
            <div class="section_content section_content--p10">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-10">Data Pelajaran SMA Kelas 2</h2>
                            <div class="noti__item js-item-menu">
                                ...
                                <div class="mess-dropdown js-dropdown">
                                    ...
                                    <div class="mess__item">
                                        <form action="/adminsma2/create" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <button type="submit" class="btn btn-warning" data-dismiss=""><a href="{{route('admin.sma2')}}">Close </a></button>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <tbody>
                                                ...
                                                <td>
                                                    <a href="/adminsma2/{{$smadua->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Hapus Data ?')">Delete</a>
                                                </td>
                                                <tr>
                                            @endforeach
                                        </tbody>
