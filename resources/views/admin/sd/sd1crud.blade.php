        ...
        <div class="main-content">
            <div class="section_content section_content--p10">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-lg-12">
                            <h2 class="title-1 m-b-10">Data Pelajaran SD Kelas 1</h2>
                            <div class="noti__item js-item-menu">
                                ...
                                <div class="mess-dropdown js-dropdown">
                                    ...
                                    <div class="mess__item">
                                        <form action="/adminsd1/create" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            ...
                                            <button type="submit" class="btn btn-warning" data-dismiss=""><a href="{{route('admin.sd1')}}">Close </a></button>
                                ...
                                <table class="table table-hover">
                                    <thead>
                                        ...
                                        <tbody>
                                                ...
                                                <td>{{$sdsatu->mapel}}</td>
                                                <td>{{$sdsatu->judul}}</td>
                                                <td>{{$sdsatu->videopel}}</td>
                                                <td>{{$sdsatu->dokumen}}</td>
    
                                                <td>
                                                    <a href="/adminsd1/{{$sdsatu->id}}/edit" class="btn btn-warning btn-sm">Edit</a>
                                                </td>
                                                <td>
                                                    <a href="/adminsd1/{{$sdsatu->id}}/delete" class="btn btn-danger btn-sm" onclick="return confirm('Hapus Data ?')">Delete</a>
                                                </td>
                                                <tr>
                                            @endforeach
                                        </tbody>
